...
This AGENTS.md scopes guidance to `analysis`. Parent AGENTS guidance still applies unless this file narrows it for this subtree.
...
### Files
- `codex-session-history-analysis.md`
