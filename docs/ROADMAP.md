...
- Resolve consumer manual acceptance findings from `docs/DRAFTKIT_MANUAL_ACCEPTANCE_FINDINGS.md`, starting with a dedicated DraftKit-owned draft preview port instead of reusing the live app port.
